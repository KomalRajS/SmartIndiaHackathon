...
function Chat(props) {
    ...
    if ("geolocation" in navigator) {
      navigator.geolocation.getCurrentPosition(
        (position) => {
          ...
          setcurrLocation([longitude, latitude]);
        },
        (err) => {
  ...
  useEffect(() => {
    ...
    socket.on("users", (users) => {
      const messagesArr = [];
      for (const { userId, username, location } of users) {
        ...
        if (props.updateAllReqLocFun)
          props.updateAllReqLocFun({ username: username, location: location });
            ...
            <div className="row">
              ...
              <div className="d-flex align-items-center justify-content-center ">
                <div className="col-4 position-relative">
                  ...
                  {User && User.rescue_team ? (
                    User.rescue_team == props.id ||
                    User.rescue_team + "req" + User._id == props.reqUserId ? (
                      <button
